    ...
    var pattern = Base.extend({
        ...
        init: function () {
            ...
            $(
                ...
                "change.dgf",
                $.proxy(
                    dataGridField2Functions.onInsert,
        ...
        getInputOrSelect: function (node) {
        ...
        autoInsertRow: function (currnode, ensureMinimumRows) {
            ...
            var dgf = $(
                dataGridField2Functions.getParentByClass(
                    currnode,
                    "datagridwidget-table-view"
                )
            );
            var tbody = dataGridField2Functions.getParentByClass(
                currnode,
                "datagridwidget-body"
            );
            ...
            dataGridField2Functions.updateOrderIndex(
                tbody,
                true,
                ensureMinimumRows
            );
        ...
        addRowAfter: function (currnode) {
            ...
            if (
                thisRow.hasClass("auto-append") &&
                !thisRow.hasClass("minimum-row")
            ) {
                $(newtr).insertBefore(thisRow);
            } else {
                $(newtr).insertAfter(thisRow);
        ...
        removeFieldRow: function (node) {
            ...
            if (
                $(tbody).data("auto-append") ||
                !this.ensureMinimumRows(tbody)
            ) {
                this.updateOrderIndex(tbody, false);
            }
        },

        moveRow: function (currnode, direction) {
        ...
        moveRowDown: function (currnode) {
            this.moveRow(currnode, "down");
        },

        moveRowUp: function (currnode) {
        ...
        reindexRow: function (tbody, row, newindex) {
            /**
        ...
        supressEnsureMinimum: function (tbody) {
            /**
        ...
        updateOrderIndex: function (tbody, backwards, ensureMinimumRows) {
            /**
            ...
            $tbody.attr(
                "data-visible-count",
                this.getVisibleRows(tbody).length
            );
        ...
        getParentElement: function (currnode, tagname) {
        ...
        getParentByClass: function (node, klass) {
        ...
        getParentElementById: function (currnode, id) {
            /**
        ...
        ensureMinimumRows: function (tbody) {
            /**
